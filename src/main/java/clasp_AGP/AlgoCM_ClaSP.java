...
public class AlgoCM_ClaSP {
     ...
     * @param itemsFrequenciesPath      the path in which each items frequency
     *                                  should be stored
     * @throws IOException
     */
    ...
    protected void claSP(SequenceDatabase database, double minSupRelative, boolean keepPatterns, boolean verbose,
        ...
        // update COOC map
        // List<Sequence> filteredSequenceList = new ArrayList<>();
        // int maximumLength = 0;
        // for (Sequence seq : database.getSequences()) {
        //     Itemset itemset = seq.get(0);
        //     Pattern extension = new Pattern(new ArrayList<>());
        //     Item item = itemset.get(0);
        ...
        //     int intersectionLength = extension.getIntersectionsLength(itemConstraint);
        //     if (intersectionLength == maximumLength) {
        //         filteredSequenceList.add(seq);
        //     } else if (intersectionLength > maximumLength) {
        //         maximumLength = intersectionLength;
        //         filteredSequenceList = new ArrayList<>();
        //         filteredSequenceList.add(seq);
        //     }
        //     // System.out.println(intersection.getSupport());
        //     // System.out.println("===");
        //     // System.out.println(extension.getSupport());
        // }

        // System.out.println(filteredSequenceList);
        ...
        //         abstractionCreator, minSupRelative, saver, itemConstraint);
        ...
        // // @TODO @SADJADRE should refactor this sections. This whole code is
        // implemented
        // // for seqeunce detection not just simply cooccurance probability detection
        // List<Entry<Pattern, Trie>> outputPatternsFromMainMethod =
        // FrequentAtomsTrie.preorderTraversal(null);
        ...
        // frequentPatternEnumeration.getFrequentClosedPatterns();
        // if (verbose) {
        // System.out.println("ClaSP:The post-processing algorithm to remove the
        // non-Closed patterns takes "
